...
public class UserPreferencesController implements Controller {
  ...
  public enum Property {LANGUAGE, UNIT, CURRENCY, VALUE_ADDED_TAX_ENABLED,
      ...
      INVERT_3D_NAVIGATION_HORIZONTAL, INVERT_3D_NAVIGATION_VERTICAL, ENHANCED_TOUCH_INPUT_ENABLED, CYCLE_OVERLAPPING_SELECTION_ENABLED,
  ...
  private boolean                       invert3DNavigationHorizontal;
  private boolean                       invert3DNavigationVertical;
  private boolean                       enhancedTouchInputEnabled;
  private boolean                       cycleOverlappingSelectionEnabled;
  ...
  protected void updateProperties() {
    ...
    setInvert3DNavigationHorizontal(this.preferences.isInvert3DNavigationHorizontal());
    setInvert3DNavigationVertical(this.preferences.isInvert3DNavigationVertical());
    setEnhancedTouchInputEnabled(this.preferences.isEnhancedTouchInputEnabled());
    setCycleOverlappingSelectionEnabled(this.preferences.isCycleOverlappingSelectionEnabled());
  ...
  public void setInvert3DNavigationHorizontal(boolean invert3DNavigationHorizontal) {
    if (invert3DNavigationHorizontal != this.invert3DNavigationHorizontal) {
      this.invert3DNavigationHorizontal = invert3DNavigationHorizontal;
      this.propertyChangeSupport.firePropertyChange(Property.INVERT_3D_NAVIGATION_HORIZONTAL.name(),
          !invert3DNavigationHorizontal, invert3DNavigationHorizontal);
    }
  }

  public boolean isInvert3DNavigationHorizontal() {
    return this.invert3DNavigationHorizontal;
  }

  public void setInvert3DNavigationVertical(boolean invert3DNavigationVertical) {
    if (invert3DNavigationVertical != this.invert3DNavigationVertical) {
      this.invert3DNavigationVertical = invert3DNavigationVertical;
      this.propertyChangeSupport.firePropertyChange(Property.INVERT_3D_NAVIGATION_VERTICAL.name(),
          !invert3DNavigationVertical, invert3DNavigationVertical);
    }
  }

  public boolean isInvert3DNavigationVertical() {
    return this.invert3DNavigationVertical;
  }

  public void setEnhancedTouchInputEnabled(boolean enhancedTouchInputEnabled) {
    if (enhancedTouchInputEnabled != this.enhancedTouchInputEnabled) {
      this.enhancedTouchInputEnabled = enhancedTouchInputEnabled;
      this.propertyChangeSupport.firePropertyChange(Property.ENHANCED_TOUCH_INPUT_ENABLED.name(),
          !enhancedTouchInputEnabled, enhancedTouchInputEnabled);
    }
  }

  public boolean isEnhancedTouchInputEnabled() {
    return this.enhancedTouchInputEnabled;
  }

  public void setCycleOverlappingSelectionEnabled(boolean cycleOverlappingSelectionEnabled) {
    if (cycleOverlappingSelectionEnabled != this.cycleOverlappingSelectionEnabled) {
      this.cycleOverlappingSelectionEnabled = cycleOverlappingSelectionEnabled;
      this.propertyChangeSupport.firePropertyChange(Property.CYCLE_OVERLAPPING_SELECTION_ENABLED.name(),
          !cycleOverlappingSelectionEnabled, cycleOverlappingSelectionEnabled);
    }
  }

  public boolean isCycleOverlappingSelectionEnabled() {
    return this.cycleOverlappingSelectionEnabled;
  }
  ...
  public void modifyUserPreferences() {
    ...
    this.preferences.setInvert3DNavigationHorizontal(isInvert3DNavigationHorizontal());
    this.preferences.setInvert3DNavigationVertical(isInvert3DNavigationVertical());
    this.preferences.setEnhancedTouchInputEnabled(isEnhancedTouchInputEnabled());
    this.preferences.setCycleOverlappingSelectionEnabled(isCycleOverlappingSelectionEnabled());

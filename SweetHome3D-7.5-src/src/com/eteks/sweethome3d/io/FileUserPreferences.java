...
public class FileUserPreferences extends UserPreferences {
  ...
  private static final String INVERT_3D_NAVIGATION_HORIZONTAL           = "invert3DNavigationHorizontal";
  private static final String INVERT_3D_NAVIGATION_VERTICAL             = "invert3DNavigationVertical";
  private static final String ENHANCED_TOUCH_INPUT_ENABLED              = "enhancedTouchInputEnabled";
  private static final String CYCLE_OVERLAPPING_SELECTION_ENABLED       = "cycleOverlappingSelectionEnabled";
  ...
  public FileUserPreferences(File preferencesFolder,
    ...
    setInvert3DNavigationHorizontal(preferences.getBoolean(INVERT_3D_NAVIGATION_HORIZONTAL,
        defaultPreferences.isInvert3DNavigationHorizontal()));
    setInvert3DNavigationVertical(preferences.getBoolean(INVERT_3D_NAVIGATION_VERTICAL,
        defaultPreferences.isInvert3DNavigationVertical()));
    setEnhancedTouchInputEnabled(preferences.getBoolean(ENHANCED_TOUCH_INPUT_ENABLED,
        defaultPreferences.isEnhancedTouchInputEnabled()));
    setCycleOverlappingSelectionEnabled(preferences.getBoolean(CYCLE_OVERLAPPING_SELECTION_ENABLED,
        defaultPreferences.isCycleOverlappingSelectionEnabled()));
  ...
  public void write() throws RecorderException {
    ...
    preferences.putBoolean(INVERT_3D_NAVIGATION_HORIZONTAL, isInvert3DNavigationHorizontal());
    preferences.putBoolean(INVERT_3D_NAVIGATION_VERTICAL, isInvert3DNavigationVertical());
    preferences.putBoolean(ENHANCED_TOUCH_INPUT_ENABLED, isEnhancedTouchInputEnabled());
    preferences.putBoolean(CYCLE_OVERLAPPING_SELECTION_ENABLED, isCycleOverlappingSelectionEnabled());

...
public class DefaultUserPreferences extends UserPreferences {
  ...
  DefaultUserPreferences(boolean readCatalogs,
    ...
    setInvert3DNavigationHorizontal(Boolean.parseBoolean(getOptionalLocalizedString(localizedPreferences, "invert3DNavigationHorizontal", "false")));
    setInvert3DNavigationVertical(Boolean.parseBoolean(getOptionalLocalizedString(localizedPreferences, "invert3DNavigationVertical", "false")));
    setEnhancedTouchInputEnabled(Boolean.parseBoolean(getOptionalLocalizedString(localizedPreferences, "enhancedTouchInputEnabled", "false")));
    setCycleOverlappingSelectionEnabled(Boolean.parseBoolean(getOptionalLocalizedString(localizedPreferences, "cycleOverlappingSelectionEnabled", "false")));
